<script setup lang="ts">
  import { CloudDownloadOutline, LogoGithub, OpenOutline } from '@vicons/ionicons5'
  import { NButton, NCard, NDivider, NFlex, NIcon, NTag, NText } from 'naive-ui'
  ...
  <NFlex justify="center">
    <NCard size="medium" :bordered="false" style="max-width: 640px; width: 100%">
      <NFlex align="center" :size="16">
        <div class="brand-mark brand-mark--lg">TCU</div>
        <div>
      ...
      <NFlex :size="8">
        <NButton
          :loading="
            updater.state.value.kind === 'checking' || updater.state.value.kind === 'progress'
          "
        ...
        <NButton
          v-if="updater.state.value.kind === 'available'"
          type="primary"
          @click="updater.showUpdateModal.value = true"
        >
