...
<style scoped>
  ...
  .hud-root.click-through {
    ...
    --ct-outline:
      ...
      -1px 1px 0 rgba(0, 0, 0, 0.95), 1px 1px 0 rgba(0, 0, 0, 0.95), 0 0 6px rgba(0, 0, 0, 0.85);
    --ct-outline-soft: var(--ct-outline), 0 0 2px rgba(255, 255, 255, 0.55);
  }
  ...
  .hud-root.click-through .hint.dim {
    color: #d4d4d8;
  }
  .hud-root.click-through .hint.warn {
    color: #fca5a5;
  }
</style>
